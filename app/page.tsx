...
// --- COMPONENT 1: WELCOME POPUP (Mobile Scroll Fixed) ---
const WelcomePopup = ({ onClose }: { onClose: () => void }) => {
  return (
    <motion.div
      initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
      // FIXED: Added overflow-y-auto so the whole screen scrolls if popup is tall
      className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-md overflow-y-auto"
    >
      {/* FIXED: Added min-h-full to ensure centering on desktop but expansion on mobile */}
      <div className="flex min-h-full items-center justify-center p-4 md:p-6">
        <motion.div
          initial={{ scale: 0.95, y: 20 }} animate={{ scale: 1, y: 0 }}
          className="bg-[#121212] border border-neutral-800 w-full max-w-4xl p-6 md:p-8 rounded-[2rem] relative overflow-hidden shadow-2xl flex flex-col md:flex-row gap-8 md:gap-12"
        >
          {/* Glow Effects */}
          ...
          <div className="flex-1 relative z-10 flex flex-col justify-center py-2 md:py-4">
            <div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-2xl flex items-center justify-center mb-6 md:mb-8 shadow-lg shadow-yellow-500/20">
              <Sparkles className="w-7 h-7 md:w-8 md:h-8 text-white" fill="white" />
            </div>

            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 md:mb-6 tracking-tight leading-[1.1]">
              Decode Food Labels.<br />
              <span className="text-neutral-500">Instantly.</span>
            </h2>

            <p className="text-neutral-400 text-base md:text-lg leading-relaxed mb-8 md:mb-10 max-w-md">
          ...
          <div className="flex-1 bg-[#1a1a1a] rounded-[2rem] p-6 md:p-8 flex flex-col justify-between border border-neutral-800 relative">
            <div className="space-y-6 md:space-y-8">
              <div className="flex gap-4 md:gap-5">
                <div className="mt-1 bg-blue-500/10 p-2.5 md:p-3 rounded-xl h-fit"><BrainCircuit size={22} className="text-blue-400" /></div>
                <div>
                  <h4 className="text-white font-bold text-sm md:text-base mb-1.5">Reasoning Engine</h4>
              ...
              <div className="flex gap-4 md:gap-5">
                <div className="mt-1 bg-green-500/10 p-2.5 md:p-3 rounded-xl h-fit"><ShieldCheck size={22} className="text-green-400" /></div>
                <div>
                  <h4 className="text-white font-bold text-sm md:text-base mb-1.5">Intent-First Design</h4>
                  <p className="text-neutral-400 text-xs md:text-sm leading-relaxed">
              ...
              <div className="flex gap-4 md:gap-5">
                <div className="mt-1 bg-purple-500/10 p-2.5 md:p-3 rounded-xl h-fit"><Scale size={22} className="text-purple-400" /></div>
                <div>
                  <h4 className="text-white font-bold text-sm md:text-base mb-1.5">Transparent Uncertainty</h4>
                  <p className="text-neutral-400 text-xs md:text-sm leading-relaxed">
            ...
            <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-neutral-800">
...
// --- COMPONENT 2: HELP POPUP (Fixed Swipe Physics) ---
